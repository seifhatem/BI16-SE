  ...
  <div class="col-md-12">
    <div class="card">
      ...
      <div class="content">
        <div class="typo-line">
          <h1>
            <p class="category">Header 1</p>Paper store Heading </h1>
        </div>
        <div class="typo-line">
          <h2>
            <p class="category">Header 2</p>Paper store Heading </h2>
        </div>
        <div class="typo-line">
          <h3>
            <p class="category">Header 3</p>Paper store Heading </h3>
        </div>
        <div class="typo-line">
          <h4>
            <p class="category">Header 4</p>Paper store Heading </h4>
        </div>
        <div class="typo-line">
          <h5>
            <p class="category">Header 5</p>Paper store Heading </h5>
        </div>
        <div class="typo-line">
          <h6>
            <p class="category">Header 6</p>Paper store Heading </h6>
        </div>
        <div class="typo-line">
          <p>
